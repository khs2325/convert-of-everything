...
- Atlas compatibility:
  1. [x] TexturePacker trimmed frames (task 039)
  2. [x] TexturePacker rotated frames (task 040)
  3. [x] atlas format detection and compatibility diagnostics (task 041)
- Frame tags:
  1. [x] SpriteProject model and Aseprite JSON mapping (task 042)
  2. [x] `.aseprite` frame-tag export (task 043)
- GIF:
  1. [x] supported-subset research and deterministic fixtures (task 044)
  2. [x] core animated GIF importer (task 045)
- APNG:
  1. [x] supported-subset research and deterministic fixtures (task 046)
  2. [x] core APNG importer (task 047)
- Additional free/open art tool project formats:
  1. [x] OpenRaster `.ora` research and deterministic fixtures (task 048)
  2. [x] OpenRaster `.ora` importer (task 049)
  3. [x] OpenRaster `.ora` browser UI wiring (task 050)
  4. [x] Pixelorama `.pxo` research and deterministic fixtures (task 051)
  5. [x] Pixelorama `.pxo` importer (task 052)
  6. [x] Pixelorama `.pxo` browser UI wiring (task 053)
  7. [x] Krita `.kra` minimal raster subset research and fixtures (task 054)
  8. [x] Krita `.kra` importer (task 055)
  9. [x] Krita `.kra` browser UI wiring (task 056)
  ...
  12. [x] Aseprite 32-bit RGBA compressed-cel importer and browser UI
